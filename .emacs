...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (go-projectile paradox company-go go-mode lsp-ui flyspell-correct-ivy all-the-icons-ivy w3m w3 which-key smartparens spacemacs-theme smart-mode-line company-glsl glsl-mode fic-mode google-this base16-theme fish-completion fish-mode auto-package-update haskell-mode all-the-icons neotree grails-projectile-mode ivy yaml-mode racer company flycheck-rust cargo rust-mode solarized-theme)))
...
;; Projectile
(require 'projectile)
(setq projectile-project-search-path '("~/projects/" "~/go/src/github.com/KasraF/" "~/go/src/github.com/nataluzhny/"))
