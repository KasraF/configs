...
(custom-set-variables
 ...
 '(package-selected-packages
   '(fic-mode google-this base16-theme fish-completion fish-mode auto-package-update haskell-mode all-the-icons neotree grails-projectile-mode ivy yaml-mode racer company flycheck-rust cargo rust-mode solarized-theme))
